...
@section('content')
    ...
    @endif
    <section class="app-priority-list">

        <!-- list and filter start -->
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Priority list</h4>
                <a href="{{ route('app-priority-add') }}" class="col-md-2 btn btn-primary">Add Priority
                </a>
            </div>
            <div class="card-body border-bottom">
                <div class="card-datatable table-responsive pt-0">
                    <table class="user-list-table table dt-responsive" id="priority-table">
                        <thead>
                            <tr>
    ...
    <script>
        $(document).ready(function() {
            $('#priority-table').DataTable({
                ...
                ajax: "{{ route('app-priority-get-all') }}",
                columns: [{
                        data: 'actions',
                        name: 'actions',
                        orderable: false,
        ...
        $(document).on("click", ".confirm-delete", function(e) {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    window.location.href = '/app/priority/destroy/' + id;
                    Swal.fire({
                        icon: 'success',
                        title: 'Deleted!',
