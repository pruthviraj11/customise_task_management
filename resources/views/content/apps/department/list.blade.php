...
@section('content')
    ...
    @endif
    <section class="app-department-list">

        <!-- list and filter start -->
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Departments list</h4>
                <a href="{{ route('app-department-add') }}" class="col-md-2 btn btn-primary">Add Department
                </a>
            </div>
    ...
    function newexportaction(e, dt, button, config) {
        ...
        $(document).on("click", ".confirm-delete", function(e) {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    window.location.href = '/app/department/destroy/' + id;
                    Swal.fire({
                        icon: 'success',
                        title: 'Deleted!',
