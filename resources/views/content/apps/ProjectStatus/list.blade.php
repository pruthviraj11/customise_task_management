...
@section('title', 'Project Status List')
...
@section('content')
    ...
    @endif
    <section class="app-status-list">

        <!-- list and filter start -->
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Project Status list</h4>
                <a href="{{ route('app-project-status-add') }}" class="col-md-2 btn btn-primary">Add Project Status
                </a>
            </div>
    ...
    <script>
        ...
        $(document).on("click", ".confirm-delete", function(e) {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    window.location.href = '/app/project_status/destroy/' + id;
                    Swal.fire({
                        icon: 'success',
                        title: 'Deleted!',
