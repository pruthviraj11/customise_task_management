...
@section('content')
    ...
    @endif
    <section class="app-locations-list">

        <!-- list and filter start -->
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Locations list</h4>
                <a href="{{ route('app-locations-add') }}" class="col-md-2 btn btn-primary">Add Location
                </a>
            </div>
            <div class="card-body border-bottom">
                <div class="card-datatable table-responsive pt-0">
                    <table class="user-list-table table dt-responsive" id="locations-table">
                        <thead>
                            <tr>
...
@section('page-script')
    ...
    $('#locations-table').DataTable({
        processing: true,
        serverSide: true,
        ajax: "{{ route('app-locations-get-all') }}",
        columns: [
            {
                data: 'actions',
                name: 'actions',
    ...
    function newexportaction(e, dt, button, config) {
        ...
        $(document).on("click", ".confirm-delete", function(e) {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    window.location.href = '/app/locations/destroy/' + id;
                    Swal.fire({
                        icon: 'success',
                        title: 'Deleted!',
